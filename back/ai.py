...
async def generate_quiz(job_description: str, company_data: str):
    prompt = f'''
Tu es un générateur de quiz pour des entretiens d'embauche.
Génère un quiz d'entretien pour ce poste : {job_description} en te basant sur : {company_data}.
Le quiz doit être composé de 20 questions.
